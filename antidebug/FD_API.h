...
void FD_API(){
	...
	r = CallDllFun("ntdll", "NtQueryInformationProcess",GetCurrentProcess(), 0x07, &Debug, sizeof(Debug), 0);
	if (Debug)
	...
	r = CallDllFun("ntdll", "NtQueryInformationProcess", GetCurrentProcess(),0x1e, &Debug, sizeof(Debug), 0);
	if (Debug)
	...
	r = CallDllFun("ntdll", "NtQueryInformationProcess",GetCurrentProcess(), 0x1f, &Debug, sizeof(Debug), 0);
	if (Debug==0)
